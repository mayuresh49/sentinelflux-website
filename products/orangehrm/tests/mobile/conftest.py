"""Mobile-specific fixtures — Appium driver lifecycle for OrangeHRM."""
...
def mobile_config(orangehrm_config):
    return orangehrm_config.get("mobile", {})
...
def login_screen(appium_driver, mobile_config):
    from pages.mobile.login_screen import LoginScreen
    platform = mobile_config.get("platform", "android")
    return LoginScreen(appium_driver, platform=platform)
