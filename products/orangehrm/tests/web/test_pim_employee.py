...
@pytest.mark.web
def test_OH_WEB_009_employee_list_loads_on_navigation(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
...
@pytest.mark.web
def test_OH_WEB_010_add_employee_with_required_fields_only(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
...
@pytest.mark.web
def test_OH_WEB_011_add_employee_with_all_fields(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
...
@pytest.mark.web
def test_OH_WEB_012_save_without_firstname_shows_validation_error(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
    pim.fill_lastname("Doe")
    pim.save()
...
@pytest.mark.web
def test_OH_WEB_013_save_without_lastname_shows_validation_error(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
    pim.fill_firstname("John")
    pim.save()
...
@pytest.mark.web
def test_OH_WEB_014_firstname_exceeding_30_chars_shows_validation_error(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
...
@pytest.mark.web
def test_OH_WEB_015_cancel_returns_to_list_without_saving(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
...
@pytest.mark.web
def test_OH_WEB_016_search_by_name_filters_results(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_list()
...
def test_OH_WEB_017_search_with_nonexistent_name_shows_no_records(logged_in_page, orangehrm_base_url):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_list()
...
def test_OH_WEB_018_add_employee_parametrized(logged_in_page, orangehrm_base_url, firstname, lastname):
    pim = PIMEmployeePage(logged_in_page, orangehrm_base_url)
    pim.navigate_to_add()
