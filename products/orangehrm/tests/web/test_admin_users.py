...
@pytest.mark.web
def test_OH_WEB_019_user_list_loads_on_navigation(logged_in_page, orangehrm_base_url):
...
@pytest.mark.web
def test_OH_WEB_020_user_list_shows_record_count(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
    admin.navigate_to_list()
...
@pytest.mark.web
def test_OH_WEB_021_search_by_admin_username_filters_results(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
    admin.navigate_to_list()
...
@pytest.mark.web
def test_OH_WEB_022_search_with_nonexistent_username_shows_no_records(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
    admin.navigate_to_list()
...
@pytest.mark.web
def test_OH_WEB_023_cancel_returns_to_list(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
...
def test_OH_WEB_024_save_without_username_shows_validation_error(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
    admin.navigate_to_add()
...
@pytest.mark.web
def test_OH_WEB_025_save_without_password_shows_validation_error(logged_in_page, orangehrm_base_url):
    admin = AdminUsersPage(logged_in_page, orangehrm_base_url)
    admin.navigate_to_add()
    admin.select_user_role("Admin")
    admin.select_status("Enabled")
