...
class VaptTestGenerator:
    ...
    _FILES_MOBILE: list[tuple[str, str]] = [
        ...
        ("test_vapt_mobile_apk_manifest.py", _MOBILE_APK_MANIFEST_TESTS),
        ("test_vapt_mobile_apk_static.py", _MOBILE_APK_STATIC_TESTS),
    ]
    ...
    _FILE_META_MOBILE: dict[str, tuple[str, str]] = {
        ...
        "test_vapt_mobile_apk_manifest.py":  ("M1/M2/M8", "MASVS-CODE — APK Manifest: debuggable, backup, cleartext, exported components"),
        "test_vapt_mobile_apk_static.py":    ("M2/M3/M5", "MASVS-STORAGE/CRYPTO — APK Static: secrets, weak crypto, cert pinning"),
    }
