...
AGENT_META: dict = {
    "app_explorer": {
        ...
        "inputs": [
            ...
            "feature_name — name of the feature being explored (required for increment/KB output)",
            "write_kb_doc — merge discovered pages into products/<product>/ai/knowledge_base/ui_pages.yaml",
            "write_increment — write a combined increment YAML to ai/knowledge_base/increments/",
        ],
        "outputs": [
            ...
            "products/<product>/ai/knowledge_base/ui_pages.yaml — KB doc (if write_kb_doc=True)",
            "ai/knowledge_base/increments/explore_<feature>_<product>.yaml — increment YAML (if write_increment=True)",
        ],
        "config_params": [
            ...
            {"name": "write_kb_doc", "type": "bool", "default": False, "description": "Merge pages into ui_pages.yaml"},
            {"name": "write_increment", "type": "bool", "default": False, "description": "Write increment YAML to increments/"},
            {"name": "feature_name", "type": "str", "default": "", "description": "Feature label for KB/increment output"},
        ],
    },
    "doc_gen": {
